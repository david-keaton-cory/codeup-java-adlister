        ...
        <div class="col-6">
            ...
            <form action="/profile/edit" method="post">
                <div class="form-group">
                    ...
                    <input id="username" name="username" class="form-control text-center" type="text" pattern="[A-Za-z0-9].{1, }" placeholder="${sessionScope.user.username}">
                </div>
            ...
            <form action="/profile/edit" method="post">
                <div class="form-group">
                    ...
                    <input id="email" name="email" class="form-control text-center" type="text" pattern="[A-Za-z0-9].{1, }" placeholder="${sessionScope.user.email}">
                </div>
                <input type="submit" class="btn btn-primary btn-block">
            </form>
            <br>
            ...
            <form action="/profile/edit" method="POST" >
                ...
                <div class="form-group">
                    ...
                    <input id="newPassword" name="newPassword" class="form-control text-center" type="password" required>
                </div>
                <div class="form-group">
                    <label for="confirmNewPassword">Confirm New Password:</label>
                    <input id="confirmNewPassword" name="confirmNewPassword" class="form-control text-center" type="password" required>
                </div>
                <input type="submit" class="btn btn-primary btn-block">
            </form>
        </div>
...
<div class="text-center">
    ...
    <a href="/profile" class="btn profile-btn btn-light">Back to profile</a>
    <a href="/" class="btn home-btn btn-light">Go to home page</a>
</div>
